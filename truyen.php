...
<body class="relative bg-base-200 z-0">
  <!-- ===HEADER=== -->
  ...
  <main class="py-16 w-full ">
    ...
    <div class=" m-5 mt-10 sm:mx-10 xl:mx-20 sm:grid auto-cols-min sm:justify-items-start sm:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-2 xl:grid-cols-5">
      ...
      <!-- buttons -->
      <div class="row-start-2 col-start-2 col-span-2 flex pt-3 items-end gap-2">
        ...
        <div class="dropdown dropdown-end md:dropdown-right">
          <label tabindex="0" class="btn  btn-outline btn-primary border-2 btn-square "><svg
      ...
      <section class="col-start-1 lg:col-start-1 md:px-4 col-end-5 justify-self-end">
        ...
        <p class="">All’s fair when love is war!
      ...
      <section
        ...
        <div class="text-xl flex pb-4 border-b items-center text-secondary  font-semibold"><svg
            xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mt-1" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd"
