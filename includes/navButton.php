<div class="p-1 w-full bg-base-200/90 backdrop-blur-lg">
  <div class="scale-95 md:scale-100 flex gap-1 items-center md:gap-2 justify-center">
    <!-- Chapter list button -->
    ...
    <div class="tooltip" data-tip="Add to favorite">
      <label type="button" class="swap btn btn-square btn-ghost">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="swap-on  h-6 w-6" fill="#36d399" viewBox="0 0 24 24"
    ...
    <!-- select chapter -->
    <select class="select select-ghost select-bordered select-sm text-base focus:outline-none">
