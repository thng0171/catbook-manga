<!-- ===Header=== -->
<header id="navbar"
    class="navbar  h-16 p-1 bg-base-100 top-0 fixed z-20 border-b justify-between border-primary lg:px-14 transition-all duration-300">
    <div class="navbar-start sm:w-fit">
        <!-- Sidebar-->
            ...
            <ul class="sidebar w-80 -left-80 duration-300 fixed inset-0 z-50 menu font-semibold p-2 h-screen overflow-y-auto bg-base-100">
    ...
    <div class="sm:gap-5 gap-2">
        ...
        <div class="z-0">
            <!-- Login button -->
            <label for="login-modal" class="btn btn-primary font-bold sm:scale-100 scale-90">Đăng nhập</label>
