...
.drawer-toggle:focus-visible~.drawer-content .drawer-button.hover\:btn-info:hover {
    outline: 2px solid hsl(var(--in))
}

.drawer-toggle:focus-visible~.drawer-content .drawer-button.hover\:btn-success:hover {
    outline: 2px solid hsl(var(--su))
}

.drawer-toggle:focus-visible~.drawer-content .drawer-button.hover\:btn-warning:hover {
    outline: 2px solid hsl(var(--wa))
}

.drawer-toggle:focus-visible~.drawer-content .drawer-button.hover\:btn-error:hover {
    outline: 2px solid hsl(var(--er))
}
...
.steps .hover\:step-info:hover+.step-info:before {
    --tw-bg-opacity: 1;
    background-color: hsl(var(--in)/var(--tw-bg-opacity))
}
...
.steps .hover\:step-success:hover+.step-success:before {
    --tw-bg-opacity: 1;
    background-color: hsl(var(--su)/var(--tw-bg-opacity))
}
...
.steps .hover\:step-warning:hover+.step-warning:before {
    --tw-bg-opacity: 1;
    background-color: hsl(var(--wa)/var(--tw-bg-opacity))
}
...
.steps .hover\:step-error:hover+.step-error:before {
    --tw-bg-opacity: 1;
    background-color: hsl(var(--er)/var(--tw-bg-opacity))
}
...
.drawer-toggle:focus-visible~.drawer-content .drawer-button.focus\:btn-info:focus {
    outline: 2px solid hsl(var(--in))
}

.drawer-toggle:focus-visible~.drawer-content .drawer-button.focus\:btn-success:focus {
    outline: 2px solid hsl(var(--su))
}

.drawer-toggle:focus-visible~.drawer-content .drawer-button.focus\:btn-warning:focus {
    outline: 2px solid hsl(var(--wa))
}

.drawer-toggle:focus-visible~.drawer-content .drawer-button.focus\:btn-error:focus {
    outline: 2px solid hsl(var(--er))
}
...
.steps .focus\:step-info:focus+.step-info:before {
    --tw-bg-opacity: 1;
    background-color: hsl(var(--in)/var(--tw-bg-opacity))
}
...
.steps .focus\:step-success:focus+.step-success:before {
    --tw-bg-opacity: 1;
    background-color: hsl(var(--su)/var(--tw-bg-opacity))
}
...
.steps .focus\:step-warning:focus+.step-warning:before {
    --tw-bg-opacity: 1;
    background-color: hsl(var(--wa)/var(--tw-bg-opacity))
}
...
.steps .focus\:step-error:focus+.step-error:before {
    --tw-bg-opacity: 1;
    background-color: hsl(var(--er)/var(--tw-bg-opacity))
}
